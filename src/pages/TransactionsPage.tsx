...
export const TransactionsPage = () => {
 ...
 return categories.find((c) => c.id === categoryId)?.color || '#c9b89a';
 }, [categories]);
 ...
 <div className="bg-white dark:bg-slate-800 rounded-lg md:rounded-xl p-4 md:p-8 text-center border border-primary-500">
