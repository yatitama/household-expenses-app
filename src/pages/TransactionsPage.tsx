                ...
                <div key={key} className="mb-3">
                  <div className="space-y-0 bg-white dark:bg-slate-800 rounded-lg">
                    <button
                      ...
                      className={`sticky w-full px-4 py-3 bg-white dark:bg-gray-800 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left z-10 rounded-t-lg border-b border-gray-200 dark:border-gray-700`}
