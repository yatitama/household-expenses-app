...
export const TransactionsPage = () => {
  ...
  return (
    <div className="pb-20">
      ...
      <div
        ref={filterBarRef}
        className="fixed top-0 left-0 right-0 z-30 bg-gray-50 dark:bg-slate-900 border-b border-primary-500/20 dark:border-primary-500/10 p-3 md:p-6 lg:p-8"
      >
        <SimpleFilterBar
          filters={filters}
      ...
      >
        {filteredTransactions.length === 0 ? (
          <div className="bg-white dark:bg-slate-800 rounded-lg md:rounded-xl shadow-sm p-4 md:p-8 text-center border border-primary-500/10 dark:border-primary-500/20">
            <Receipt size={40} className="md:w-12 md:h-12 mx-auto text-primary-300 dark:text-primary-700 mb-2 md:mb-3" />
            <p className="text-xs md:text-sm text-primary-600 dark:text-primary-400">取引がありません</p>
          </div>
        ) : (
            ...
            {groupedTransactions.map(([key, { label, transactions }], groupIndex) => {
              ...
              return (
                <div key={key}>
                  ...
                  <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm overflow-hidden border border-primary-500/10 dark:border-primary-500/20">
                    <div className="px-4 py-2 bg-primary-50/50 dark:bg-primary-900/20 border-b border-primary-500/20 dark:border-primary-500/30 flex items-center justify-between">
                      <p className="text-xs md:text-sm font-medium text-primary-700 dark:text-primary-400">{label}</p>
                  ...
                  {transactions.map((t) => {
                    ...
                    return (
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 hover:bg-primary-50/50 dark:hover:bg-primary-900/20 transition-colors text-left"
                      >
                        <div
