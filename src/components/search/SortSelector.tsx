  ...
  return (
    <div className="flex items-center gap-2">
      <select
        ...
        className="border rounded-lg px-3 py-2.5 text-sm transition-all focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-primary-600"
        aria-label="並び替え基準"
      >
      ...
      <button
        ...
        className="flex items-center gap-1 px-3 py-2 rounded-lg text-sm text-gray-700 hover:bg-gray-50"
