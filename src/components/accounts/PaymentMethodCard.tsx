...
export const PaymentMethodCard = ({
 ...
 return (
 <div className="bg-white dark:bg-slate-800 rounded-lg md:rounded-xl p-3 md:p-4">
 ...
 <Link2 size={10} className="md:w-3 md:h-3" style={{color: linkedAccountName ? '#8b7355' : '#c9b89a'}} />
