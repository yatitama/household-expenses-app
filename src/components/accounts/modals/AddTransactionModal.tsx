      ...
      >
                ...
                <div className="grid grid-cols-4 gap-2">
                  {allAccounts.map((acct) => (
                    ...
                    >
                      ...
                      <span className="text-[10px] sm:text-xs text-gray-900 dark:text-gray-200 truncate w-full text-center leading-tight">
                        {acct.name}
                      </span>
                      {selectedSourceId === acct.id && (
                        <div className="absolute -top-1 -right-1">
        ...
        <div className="border-t dark:border-gray-700 p-3 sm:p-4">
          <button
            ...
            className="w-full py-2 sm:py-2.5 px-3 sm:px-4 rounded-lg bg-primary-600 hover:bg-primary-700 text-white font-medium text-sm disabled:opacity-50 transition-colors"
          >
            登録
          </button>
        </div>
