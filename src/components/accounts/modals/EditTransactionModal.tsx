...
export const EditTransactionModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-end sm:items-center justify-center z-[60]" onClick={onClose} role="dialog" aria-modal="true" aria-label="取引を編集">
      <div
        className="premium-card w-full max-w-md sm:rounded-xl rounded-t-xl p-5 max-h-[85vh] overflow-y-auto animate-scale-in"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button
              ...
              className="btn-primary flex-1 py-2.5 px-4 disabled:opacity-50"
            >
              保存
            </button>
          </div>
