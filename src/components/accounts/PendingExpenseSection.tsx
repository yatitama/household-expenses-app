...
export const PendingExpenseSection = ({
  ...
  return (
    <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg md:rounded-xl p-3 md:p-4 border border-amber-200 dark:border-amber-800">
      <div className="flex items-center gap-1.5 md:gap-2 mb-2 md:mb-3">
        <AlertCircle size={16} className="md:w-4.5 md:h-4.5 text-amber-600 dark:text-amber-400 flex-shrink-0" />
        <h3 className="text-xs md:text-sm font-semibold text-amber-900 dark:text-amber-100">今月の支出予測</h3>
      </div>
      ...
      <div className="space-y-1.5 md:space-y-2">
        ...
        {(totalCardPending > 0 || totalRecurringExpense > 0 || totalRecurringIncome > 0) && (
          <div className="border-t border-amber-200 dark:border-amber-800 pt-1.5 md:pt-2 mt-1.5 md:mt-2 flex justify-between items-center text-xs md:text-sm">
